export function createExperienceSearchTool(store) {
    return {
        name: 'experience_search',
        isConcurrencySafe: true,
        description: 'Search the robotics experience store for past experiment results, algorithm insights, and lessons learned. ' +
