...
export type KernelEvent = TextDeltaEvent | ThinkingDeltaEvent | ToolUseEvent | ToolResultEvent | CompactBoundaryEvent | ApiRetryEvent | ToolUseSummaryEvent | SystemMessageEvent | ResultEvent;
