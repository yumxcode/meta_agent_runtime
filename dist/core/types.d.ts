...
export type MetaAgentEvent = MetaAgentTextEvent | MetaAgentThinkingDeltaEvent | MetaAgentToolUseEvent | MetaAgentToolResultEvent | MetaAgentResultEvent | MetaAgentStreamEvent | MetaAgentRetryEvent;
/**
...
export type ToolPermissionCategory = 'read' | 'write' | 'execute' | 'network' | 'config' | 'state';
