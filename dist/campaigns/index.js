...
import { doeCampaignPlugin } from './doe/index.js';
import { paperReproCampaignPlugin } from './paper-repro/index.js';
campaignRegistry.register(doeCampaignPlugin);
campaignRegistry.register(paperReproCampaignPlugin);
