...
export class SubAgentRunner {
    ...
    async _run() {
        ...
        if (cfg.sandbox) {
            ...
            process.stderr.write(`[meta-agent/sandbox:${this.taskId}] sandbox active — ${sandboxHandle.description}\n`);
        }
     ...
     */
    async _resolveToolsWithSandbox(sandboxHandle) {
        ...
        return Promise.all(tools.map(async (t) => t.name === 'bash'
