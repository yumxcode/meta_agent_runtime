import { validateExperienceInput } from '../../ExperiencePendingStore.js';
// ─────────────────────────────────────────────────────────────────────────────
 ...
 */
export function createExperienceWriteTool(_store, pendingStore, flash) {
    return {
        name: 'experience_write',
        description: 'Propose a new experience entry to the robotics knowledge base. ' +
        ...
        async call(input) {
            try {
                ...
                if (!normalized.ok) {
                    return {
                        content: 'experience_write rejected invalid input. Required fields: ' +
                ...
                if (flash) {
                    ...
                    if (raw?.trim())
                        abstractPrinciple = raw.trim().slice(0, 400);
                }
