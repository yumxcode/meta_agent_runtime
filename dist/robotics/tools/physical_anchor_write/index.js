import { validatePhysicalAnchorInput } from '../../PhysicalAnchorPendingStore.js';
export function createPhysicalAnchorWriteTool(pendingStore) {
    return {
        name: 'physical_anchor_write',
        description: 'Propose a physical/device fact that should anchor robotics reasoning. ' +
