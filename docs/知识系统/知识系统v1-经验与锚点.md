...
- **anchor ↔ experience 双边关系**:见 `docs/知识系统/物理锚点接入方案.md`(经验认领锚点、三档 verdict 回灌、反证沿支撑边传播、anchor↔principle 回链、晋升接锚点)。
- **principle 全链路**:见 `docs/知识系统/原则机制改进方案.md`(收敛晋升、严格抽象判官)+ 本期跳过的 principle 召回(R7)。
