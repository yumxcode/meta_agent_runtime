...
根目录现存：
- `README.md`
- `docs/architecture/meta-agent-architecture.md`
- `docs/reports/REPORT_ARCHITECTURE.md`
- `docs/reports/REPORT_FUNCTIONAL.md`
- `docs/reviews/CODE_REVIEW.md`
- `docs/architecture/sandbox_architecture_plan.svg`
- `docs/` 目录还有更多
