 ...
 */
export declare function loadToolPrompt(moduleUrl: string): Promise<string>;
/**
 ...
 *   })
 */
export declare function dynamicDescription(moduleUrlOrContent: string, enhance: (base: string, ctx: ToolDescriptionContext) => string): ToolDescription;
