...
export const BASE_DIMENSIONS: BaseDimension[] = [
...
// ─────────────────────────────────────────────────────────────────────────────
// Dimension error (from DimensionalConsistencyChecker)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Dimension spec (tool schema fragment for dimension declarations)
// ─────────────────────────────────────────────────────────────────────────────
 ...
 *   }
 */
export type DimensionSpec = Record<string, { dimension?: DimensionVector; required?: boolean }>
