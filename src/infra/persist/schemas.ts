 ...
 * Usage pattern (P2-A):
 *
 *   import { TeamStateSchema, EngineeringJobSchema, parseOrNull } from '../persist/schemas.js' (or core/persist shim)
 *
...
export const TEAM_STATE_LATEST_VERSION = '2.0' as const
 ...
 */
export function migrateTeamState(raw: unknown): TeamStateValidated | null {
...
function mapLegacyStatus(status: z.infer<typeof LegacyV10TaskStatusSchema>): z.infer<typeof TeamTaskStatusSchema> {
  switch (status) {
    case 'done':
    case 'cancelled':
      return 'done'
...
export const SessionMetaSchema = z.object({
  ...
  loopInstanceId: z.string().optional(),
