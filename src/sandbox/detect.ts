...
let _platform: NodeJS.Platform | undefined
let _sandboxExecAvailable: boolean | undefined
let _bwrapAvailable: boolean | undefined
let _bwrapVersion: string | undefined
...
export function getPlatform(): NodeJS.Platform {
  if (_platform === undefined) _platform = process.platform
  return _platform
}
...
export function isSandboxExecAvailable(): boolean {
  if (_sandboxExecAvailable !== undefined) return _sandboxExecAvailable
 ...
 */
export function getBwrapVersion(): string | undefined {
  if (_bwrapAvailable === undefined) isBwrapAvailable()
...
// ─────────────────────────────────────────────────────────────────────────────
// Summary helper (used by index.ts factory)
// ─────────────────────────────────────────────────────────────────────────────

export interface SandboxAvailability {
  platform: NodeJS.Platform
  sandboxExec: boolean   // macOS
  bwrap: boolean         // Linux
  bwrapVersion?: string
  nestedBwrap: boolean
}

export function getSandboxAvailability(): SandboxAvailability {
  return {
